...
public class GenerateDao {
  ...
  public static void createDaoStaticTemplate(String filePath, String packageName) {
    String[] templates = { "BaseDao.java", "CustomPageable.java", "SearchParameter.java" };
    for (String template : templates) {
      ...
      try {
        ...
        FileUtil.fileWrite(filePath + "\\" + template, result);

        if (FileUtil.existFile(filePath + "\\" + template)) {
